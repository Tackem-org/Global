...
func (x *TaskMessage) GetWho() isTaskMessage_Who {
	if x != nil {
		return x.Who
	}
	return nil
...
func (x *TaskMessage) GetAdminOnly() bool {
	if x != nil {
		if x, ok := x.Who.(*TaskMessage_AdminOnly); ok {
			return x.AdminOnly
		}
	}
	return false
...
func (x *TaskMessage) GetPermission() string {
	if x != nil {
		if x, ok := x.Who.(*TaskMessage_Permission); ok {
			return x.Permission
		}
	}
	return ""
...
func (x *TaskMessage) GetUserId() uint64 {
	if x != nil {
		if x, ok := x.Who.(*TaskMessage_UserId); ok {
			return x.UserId
		}
	}
	return 0
...
type TaskAction struct {
	...
	Command       map[string]string      `protobuf:"bytes,3,rep,name=command,proto3" json:"command,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NotificationMessage) GetWho() isNotificationMessage_Who {
	if x != nil {
		return x.Who
	}
	return nil
...
func (x *NotificationMessage) GetAdminOnly() bool {
	if x != nil {
		if x, ok := x.Who.(*NotificationMessage_AdminOnly); ok {
			return x.AdminOnly
		}
	}
	return false
...
func (x *NotificationMessage) GetPermission() string {
	if x != nil {
		if x, ok := x.Who.(*NotificationMessage_Permission); ok {
			return x.Permission
		}
	}
	return ""
...
func (x *NotificationMessage) GetUserId() uint64 {
	if x != nil {
		if x, ok := x.Who.(*NotificationMessage_UserId); ok {
			return x.UserId
		}
	}
	return 0
...
func file_web_proto_init() {
	...
	file_web_proto_msgTypes[0].OneofWrappers = []any{
		(*TaskMessage_AdminOnly)(nil),
		(*TaskMessage_Permission)(nil),
		(*TaskMessage_UserId)(nil),
	}
	file_web_proto_msgTypes[7].OneofWrappers = []any{

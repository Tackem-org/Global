...
const (
	Web_SendNotification_FullMethodName = "/web.Web/SendNotification"
	Web_SendTask_FullMethodName         = "/web.Web/SendTask"
	Web_RemoveTask_FullMethodName       = "/web.Web/RemoveTask"
	Web_SendWebSocket_FullMethodName    = "/web.Web/SendWebSocket"
)
...
func (c *webClient) SendNotification(ctx context.Context, in *NotificationMessage, opts ...grpc.CallOption) (*SendNotificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, Web_SendNotification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webClient) SendTask(ctx context.Context, in *TaskMessage, opts ...grpc.CallOption) (*SendTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, Web_SendTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webClient) RemoveTask(ctx context.Context, in *RemoveTaskRequest, opts ...grpc.CallOption) (*RemoveTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, Web_RemoveTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webClient) SendWebSocket(ctx context.Context, in *SendWebSocketRequest, opts ...grpc.CallOption) (*SendWebSocketResponse, error) {
	...
	err := c.cc.Invoke(ctx, Web_SendWebSocket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Web_SendNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Web_SendNotification_FullMethodName,
	}
...
func _Web_SendTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Web_SendTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Web_RemoveTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Web_RemoveTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Web_SendWebSocket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Web_SendWebSocket_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
